...
from backend.api.v1.subject.routers.subject import router as subject_router
from backend.api.v1.subject.routers.subject_transactions import (
...
from backend.api.v1.user.routers.user_me_transactions import (
    router as user_me_transactions_router,
)
from backend.api.v1.wallet.routers.wallet import router as wallet_router
